...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default-si.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf
	rm -rf /root/VPS-MX
...
ubu16_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/Repositorios/16.04/sources.list &> /dev/null
	echo -e "\033[1;97m SELECCIONO UBU 16"
}

ubu18_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/Repositorios/18.04/sources.list &> /dev/null
...
echo -e "\e[1;100mTE INFORMO QUE ESTE SCRIPT ES TOTALMENTE\n GRATUITO Y DE CODIGO ABIERTO\n ESTA PROHIBIDA SU VENTA, NO SEAS VICTIMA DE ESTAFA... \e[0m"
msg -bar
