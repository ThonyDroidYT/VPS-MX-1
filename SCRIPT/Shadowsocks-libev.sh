...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
...
fun_shadowsocks
rm -rf shadowsocks-all.shcks-all.sh