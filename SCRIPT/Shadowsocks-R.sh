...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
...
fun_shadowsocks
rm -rf Instalador-Shadowsocks-R.shsocks-R.sh