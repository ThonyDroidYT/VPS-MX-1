...
source <(curl -sL https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/V2RAY/install.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/V2RAY/install.sh) --remove
}
infocuenta () {
v2ray info
}
