...
echo 'echo -e "\033[92m\t 0101010101010101010101010101010101010101"'>> .bashrc
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "Code de KEY Invalido!") ]]; then
   ...
   echo -e "\033[1;34m  (Debes tener Telegram y el BOT: @Noti_VPSMX_Bot)"
   msg -bar2
   read -p " [ s | n ]: " NOTIFY   
