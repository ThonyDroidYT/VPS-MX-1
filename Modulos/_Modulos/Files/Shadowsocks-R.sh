...
msg -bar
msg -tit
echo -e "${cor[3]}    INSTALADOR SHADOWSOCK-R+(obfs) By @Razhiel"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
