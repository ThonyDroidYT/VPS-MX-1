...
source <(curl -sL https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/V2RAY/install-v2ray.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/V2RAY/install-v2ray.sh) --remove > /dev/null 2>&1
