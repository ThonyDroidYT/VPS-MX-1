...
cd socks
patch="https://raw.githubusercontent.com/Razhiel2019/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/backsocz"
arq="backsocz"
...
msg -bar 
msg -tit
msg -ama "  INSTALADOR DE PROXY'S VPS-MX RELOADED By MOD @Razhiel"
msg -bar
