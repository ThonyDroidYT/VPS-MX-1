...
msg -bar
echo -e "\033[97m"
echo -e "\033[41m -- INSTALACION DE PAQUETES NECESARIOS PARA VPS-MNG -- "
...
msg -bar2
echo -e "\033[1;97m  ¿PRESENTO ERROR ALGUN PAQUETE ANTERIOR?" 
msg -bar2
...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/Control-IP")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;95m======================================================\n ¡ESTA KEY NO CONCUERDA CON EL INSTALADOR!,CONTACTE A @Kalix1\n======================================================\n"
  [[ -d /etc/newadm ]] && rm -rf /etc/newadm
  exit 1
  } || {

 ### INTALAR VERCION DE SCRIPT
  v1=$(curl -sSL "https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/Vercion")
  echo "$v1" > /etc/versin_script
  }
}
funcao_idioma () {
msg -bar2
figlet "    -VPS-MNG-" | lolcat 
...
[[ $(find /etc/newadm/ger-user -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/newadm/ger-user/nombre.log https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/newadm/ger-user -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/newadm/ger-user/IDT.log https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/newadm/ger-user -name tiemlim.log|grep -w "tiemlim.log"|head -1) ]] || wget -O /etc/newadm/ger-user/tiemlim.log https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/tiemlim.log &>/dev/null

wget -O /bin/rebootnb https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/resetsshdrop &> /dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/Vercion &>/dev/null
msg -bar2
...
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/Vercion &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
NOTIFY () {
msg -bar
msg -ama " Notify-BOT (Notificasion Remota)| VPS-MNG By @RZHLM "
msg -bar
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/Razhiel2019/VPS-MNG/main/ArchivosUtilitarios/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MNG - SCRIPT \033[1;97m ❌ MOD By Razhiel ❌\033[1;33m ]"
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " INSTALANDO"|sed -e 's/[^a-z -]//ig'): \033[1;31m[VPS-MNG #MOD by Razhiel]"
